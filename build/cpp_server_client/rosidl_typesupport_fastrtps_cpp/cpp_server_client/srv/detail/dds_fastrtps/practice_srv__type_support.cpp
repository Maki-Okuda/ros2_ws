...
#include "cpp_server_client/srv/detail/practice_srv__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: num_vector
  {
    ...
    size_t item_size = sizeof(ros_message.num_vector[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cpp_server_client::srv::PracticeSrv_Request;
    is_plain =
      (
      offsetof(DataType, num_vector) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const cpp_server_client::srv::PracticeSrv_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cpp_server_client::srv::PracticeSrv_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PracticeSrv_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cpp_server_client::srv::PracticeSrv_Request *>(
...
static size_t _PracticeSrv_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PracticeSrv_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PracticeSrv_Request__callbacks = {
...
static rosidl_message_type_support_t _PracticeSrv_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PracticeSrv_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_cpp_server_client
const rosidl_message_type_support_t *
get_message_type_support_handle<cpp_server_client::srv::PracticeSrv_Request>()
{
  return &cpp_server_client::srv::typesupport_fastrtps_cpp::_PracticeSrv_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cpp_server_client::srv::PracticeSrv_Response;
    is_plain =
      (
      offsetof(DataType, cumulative_sum) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const cpp_server_client::srv::PracticeSrv_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cpp_server_client::srv::PracticeSrv_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PracticeSrv_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cpp_server_client::srv::PracticeSrv_Response *>(
...
static size_t _PracticeSrv_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PracticeSrv_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PracticeSrv_Response__callbacks = {
  "cpp_server_client::srv",
...
static rosidl_message_type_support_t _PracticeSrv_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PracticeSrv_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &cpp_server_client::srv::typesupport_fastrtps_cpp::_PracticeSrv_Response__handle;
}
...
static service_type_support_callbacks_t _PracticeSrv__callbacks = {
  "cpp_server_client::srv",
  "PracticeSrv",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_server_client, srv, PracticeSrv_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_server_client, srv, PracticeSrv_Response)(),
...
static rosidl_service_type_support_t _PracticeSrv__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PracticeSrv__callbacks,
...
{
  return &cpp_server_client::srv::typesupport_fastrtps_cpp::_PracticeSrv__handle;
}
